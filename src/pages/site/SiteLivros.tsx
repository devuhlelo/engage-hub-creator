...
const SiteLivros: React.FC = () => {
  ...
  const livros = getData<any[]>("livros", []);
      ...
      <div className="max-w-6xl mx-auto px-6 py-12">
        <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-8">
          {livros.map((l) => (
            <div
              key={l.id}
              className="group border overflow-hidden shadow-sm hover:shadow-xl hover:-translate-y-2 transition-all duration-300 text-center"
            ...
            >
              ...
              <div className="p-5">
                <span
                  ...
                  style={{
                    background: l.tipo === "escrito" ? `${theme.primaryColor}15` : `${theme.accentColor}15`,
                    color: l.tipo === "escrito" ? theme.primaryColor : theme.accentColor,
                  }}
                >
        ...
        {livros.length === 0 && (
          <div className="text-center py-20">
            ...
            <p className="text-sm opacity-30 mt-1">Cadastre livros no painel CMS.</p>
          </div>
        )}
      </div>
    </div>
